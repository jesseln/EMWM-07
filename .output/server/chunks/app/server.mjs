import { hasInjectionContext, getCurrentInstance, inject, toRaw, isRef, isReactive, toRef, version, ref, watchEffect, watch, defineAsyncComponent, pushScopeId, popScopeId, defineComponent, h, Suspense, nextTick, Transition, unref, provide, shallowReactive, useSSRContext, createApp, reactive, effectScope, openBlock, createBlock, getCurrentScope, onScopeDispose, createElementBlock, normalizeClass, renderSlot, normalizeProps, guardReactiveProps, withScopeId, resolveComponent, normalizeStyle, withKeys, createElementVNode, Fragment, createCommentVNode, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, shallowRef, isReadonly, toRefs, markRaw, computed, isShallow, mergeProps, toDisplayString } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/about-da3351ee.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-bde53981.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "library",
    path: "/library",
    children: [
      {
        name: "library-setQuery",
        path: ":setQuery()",
        meta: {},
        alias: [],
        redirect: void 0,
        component: () => import('./_nuxt/_setQuery_-721267fc.mjs').then((m2) => m2.default || m2)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/library-32260347.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/shared-annotations-4863be54.mjs').then((m2) => m2.default || m2)
  },
  {
    name: "site-guide",
    path: "/site-guide",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/site-guide-b8ce3dcc.mjs').then((m2) => m2.default || m2)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/your-collection-eaf89153.mjs').then((m2) => m2.default || m2)
  }
];
const appHead = { "meta": [{ "name": "viewport", "content": "width=device-width, initial-scale=1" }, { "charset": "utf-8" }], "link": [{ "rel": "stylesheet", "href": "https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" }], "style": [], "script": [], "noscript": [] };
...
const revive_payload_server_jfOM46TRCC = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./_nuxt/nuxt-icon-846f527d.mjs').then((r) => r.default));
...
const unhead_Wn63kQSyvo = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  setup(nuxtApp) {
...
const supabase_server_dv7Se1mDKA = /* @__PURE__ */ defineNuxtPlugin(async () => {
  let __temp, __restore;
...
const plugins = [
  plugin$1,
  plugin,
  revive_payload_server_jfOM46TRCC,
  components_plugin_KR1HBZs4kY,
  unhead_Wn63kQSyvo,
  floating_vue_EIcJ7xiw0h,
  supabase_server_dv7Se1mDKA
];
...
const layouts = {
  default: () => import('./_nuxt/default-910d1a11.mjs').then((m2) => m2.default || m2)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-18f8b3ea.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-abd84ac4.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-6a78b7ea.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useRoute as a, __nuxt_component_0 as b, createError as c, defineStore as d, entry$1 as default, useRouter as e, useSupabaseToken as f, createSupabaseClient as g, useNuxtApp as h, navigateTo as n, storeToRefs as s, useHead as u };
